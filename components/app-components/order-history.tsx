import { orders } from '@/app/order-history/page';
          ...
          <TabsContent value="ongoing" className="space-y-6">
            {ongoingOrders?.length ? (
              ongoingOrders.map((order) => (
                <Card key={order.id} className="flex-row items-start justify-between gap-4 p-3 rounded-lg border border-border hover:bg-accent transition-colors">
                  <div className="flex">
                    <Image
                      src={
